...
export default function HeaderHomePage() {
    ...
    return (
        <div className="container-fluid header-home-page">
            {/* List product type */}
                ...
                <div className="box-carosel-header-home">
                    ...
                    <div className="row">
                        ...
                        <div style={{ textAlign: "right" }} className="col-xl-3">
                            <div className='row'>
                                <b style={{ borderRadius: "50%", background: "#f5f5f5", height: "50px", width: "50px", textAlign: "center", lineHeight: "50px" }} className='col-xl-1'>
                                    <FiPhone />
                                </b>
                                <div className='col'>
                                    <p> <b>+65 11.188.888 </b> <br />
                                        <a style={{fontSize: "14px"}}>support 24/7 time</a>
                                    </p>
                                </div>
                            </div>
