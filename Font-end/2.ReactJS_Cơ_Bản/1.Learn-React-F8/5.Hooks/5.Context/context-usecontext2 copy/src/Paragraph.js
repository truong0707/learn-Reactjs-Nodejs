import { ThemeContext } from "./ThemeContext"; // 1.3 Sử dụng Context
import { useContext } from "react"; // 1.4 Để sử dụng Consumer(nhập DL) trong context ta import useContext trong React


export default function Paragraph() {
  const context = useContext(ThemeContext) // 1.5 truyền thằng Context vào useContext của react để sử dụng
