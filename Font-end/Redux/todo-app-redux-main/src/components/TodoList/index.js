...
import { useDispatch } from "react-redux";// import user dispatch of react-redux
...
export default function TodoList() {
  ...
  const todoList = useSelector(todoListSelector) // lấy dữ liệu todo ở kho chung
    ...
    <Row style={{ height: 'calc(100% - 40px)' }}>
      ...
      <Col span={24}>
        <Input.Group style={{ display: 'flex' }} compact>
          ...
          <Button  type='primary' onClick={handleAddButtonCick}>
            Add
          </Button>
        </Input.Group>
      </Col>
